    ...
    def scrape_button_press(self, event):
        ...
        for item in range(len(switch_options)): # for all items inside switch_options
            if self.scrollable_frame_switches[i].get() == True: # if the switch is enabled
                self.textbox.insert(tkinter.END, "Analyzing results for " + switch_options[i] + ": \n")
                try:
                    if switch_options[i] == 'a':    # and the tag to search is 'a'
                        self.textbox.insert(tkinter.END, "Results for 'a href':\n")
                        ...
                        self.textbox.insert(tkinter.END, "Full HTML results:\n")
                        ...
                        self.textbox.insert(tkinter.END, "All Text from DOM:\n")
                        ...
                        self.textbox.insert(tkinter.END, "Results for '" + switch_options[i] + "':\n")
